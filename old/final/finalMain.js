...
function drawShapes() {
  drawShape(milaHead, perVertexProgram, [-0.8, -1, 0], [3, 3, 3]);
  drawShape(milaMuzzle,perVertexProgram, [0.1, -0.6, -1], [1.3, 1.3, 1.3]);
  drawShape(milaBody, perVertexProgram,[-6, -5, 3], [5, 5, 5]);
  drawShape(milaMuzzle, perVertexProgram,[0.4, -0.5, -1], [0.6, 0.6, 0.6]);
  drawShape(leaf,perVertexProgram, [-0.6, 1.9, 0.5], [3, 3, 3]);

  drawShape(milaEar, perVertexProgram, [-1.5, 0, -1], [1, 2, 1], [40, 1, 1]);
}
